...
void execute_one(void)
{
  ...
  *(uint32_t*)0x200000c4 = htobe32(0);
  ...
  memcpy((void*)0x20000080,
         "\x31\xea\x37\xec\xb0\x7e\xf3\xf8\x14\x74\x4f\x7d\x16\x04\x2a\xa3\x88"
         "\x67\xfd\xfe\x8a\xeb\x89\xfb",
         24);
  *(uint16_t*)0x20000100 = 2;
  *(uint16_t*)0x20000102 = htobe16(0x4e20);
  *(uint32_t*)0x20000104 = htobe32(0);
  syscall(__NR_sendto, r[0], 0x20000080ul, 0x18ul, 0x20008005ul, 0x20000100ul,
          0x10ul);
  syscall(__NR_recvfrom, r[0], 0ul, 0ul, 0x76ful, 0ul, 0ul);
}
int main(void)
{
